    ...
    if (
      ...
      Axios.post("http://localhost:3001/logins", {
        ...
        if (response.data.message) {
          ...
          // console.log("Hello");
        } else if (response.data[0].skillname != "Staff") {
          alert("The ID is registered as a doctor Go to Doctor login page");
      ...
      <main className="pa4 black-80">
        <div className="measure">
          <fieldset id="sign_up" className="ba b--transparent ph0 mh0">
            <legend className="f1 fw6 ph0 mh0">Staff Sign In</legend>
            <div className="mt3">
